...
export const ar: Partial<Record<TranslationKey, string>> = {
  ...
  'analysis.terms': 'المصطلحات المطابقة',
  'analysis.clickToCorrect': 'اضغط للتصحيح',
  'triage.no_signal': 'لا توجد مصطلحات مطابقة',
  'triage.insufficient_evidence': 'أدلة غير كافية',
  'triage.evidence_too_spread': 'أدلة مشتتة',
  'triage.margin_too_narrow': 'الفارق ضيق جدا',
